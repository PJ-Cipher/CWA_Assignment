  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Coming Soon Section */}
        <div className="bg-gradient-to-br from-green-50 to-yellow-50 dark:from-green-900/20 dark:to-yellow-900/20 border-2 border-dashed border-green-300 dark:border-green-600 p-12 rounded-lg text-center">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Sprint Races</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            <div className="text-4xl mb-4">🏃</div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Marathon Races</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            <div className="text-4xl mb-4">🤝</div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Team Races</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">
