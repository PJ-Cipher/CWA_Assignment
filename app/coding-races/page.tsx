  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Coming Soon Section */}
        <div className="bg-gradient-to-br from-green-50 to-yellow-50 border-2 border-dashed border-green-300 p-12 rounded-lg text-center">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Sprint Races</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            <div className="text-4xl mb-4">🏃</div>
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Marathon Races</h3>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            <div className="text-4xl mb-4">🤝</div>
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Team Races</h3>
            <p className="text-gray-600 text-sm">
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md border border-gray-200">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Frontend Interface</span>
              <span className="text-sm text-gray-500">0%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div className="bg-gray-300 h-2 rounded-full w-0"></div>
