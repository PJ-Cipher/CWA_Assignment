    ...
    <div className="bg-gray-900 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Coming Soon Section */}
          <div className="bg-gray-800 border-2 border-dashed border-green-400 p-12 rounded-lg text-center border border-gray-700">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Sprint Races</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
              <div className="text-4xl mb-4">🏃</div>
              <h3 className="text-lg font-semibold text-white mb-2">Marathon Races</h3>
              <p className="text-gray-300 text-sm">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-lg font-semibold text-white mb-2">Team Races</h3>
              <p className="text-gray-300 text-sm">
          ...
          <div className="mt-8 bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-gray-300">Frontend Interface</span>
                <span className="text-sm text-gray-400">0%</span>
              </div>
              <div className="w-full bg-gray-600 rounded-full h-2">
                <div className="bg-gray-500 h-2 rounded-full w-0"></div>
