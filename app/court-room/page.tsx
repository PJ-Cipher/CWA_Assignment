  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Coming Soon Section */}
        <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 border-2 border-dashed border-red-300 dark:border-red-600 p-12 rounded-lg text-center">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Judge</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Jury</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            <div className="text-4xl mb-4">📝</div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Defense</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Submit Code</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Peer Review</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Improve</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-600 dark:text-gray-300">Q1 2024 - Planning & Design</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-3 h-3 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
              <span className="text-gray-600 dark:text-gray-300">Q2 2024 - Backend Development</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-3 h-3 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
              <span className="text-gray-600 dark:text-gray-300">Q3 2024 - Frontend Development</span>
            </div>
            <div className="flex items-center space-x-4">
              <div className="w-3 h-3 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
              <span className="text-gray-600 dark:text-gray-300">Q4 2024 - Testing & Launch</span>
            </div>
          </div>
        </div>
