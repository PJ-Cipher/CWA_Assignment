    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Coming Soon Section */}
          <div className="bg-red-50 dark:bg-gray-800 border-2 border-dashed border-red-400 p-12 rounded-lg text-center border border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Judge</h3>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Jury</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
              <div className="text-4xl mb-4">📝</div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Defense</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
