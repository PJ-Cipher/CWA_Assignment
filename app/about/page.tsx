  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-400 p-8 rounded-lg mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-center md:text-left">
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                ...
                <p className="text-xl font-semibold text-gray-800">Pasan Jayarathna</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-sm text-gray-600 uppercase tracking-wide">Student Number</p>
                <p className="text-xl font-semibold text-gray-800">21963056</p>
              </div>
            </div>
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-sm text-gray-600 uppercase tracking-wide">Course</p>
                <p className="text-xl font-semibold text-gray-800">CSE5006 - Web Application Development</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-sm text-gray-600 uppercase tracking-wide">Institution</p>
                <p className="text-xl font-semibold text-gray-800">La Trobe University (LTU)</p>
              </div>
            </div>
          </div>
        </div>
